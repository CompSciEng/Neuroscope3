...
struct qt_meta_stringdata_ImageCreator_t {
    QByteArrayData data[6];
    char stringdata0[60];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ImageCreator_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ImageCreator_t qt_meta_stringdata_ImageCreator = {
    {
QT_MOC_LITERAL(0, 0, 12), // "ImageCreator"
QT_MOC_LITERAL(1, 13, 13), // "dataAvailable"
...
QT_MOC_LITERAL(5, 50, 9) // "initiator"
    ...
    "ImageCreator\0dataAvailable\0\0"
...
void ImageCreator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ImageCreator *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ImageCreator::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_ImageCreator.data,
    qt_meta_data_ImageCreator,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ImageCreator::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ImageCreator.stringdata0))
