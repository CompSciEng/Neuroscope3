...
QT_MOC_LITERAL(1, 11, 26), // "updateTraceBackgroundImage"
QT_MOC_LITERAL(2, 38, 0) // ""

    },
    "Properties\0updateTraceBackgroundImage\0"
    ""
};
...
QT_INIT_METAOBJECT const QMetaObject Properties::staticMetaObject = { {
    &PropertiesLayout::staticMetaObject,
    qt_meta_stringdata_Properties.data,
    qt_meta_data_Properties,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Properties::qt_metacast(const char *_clname)
{
    ...
    return PropertiesLayout::qt_metacast(_clname);
}

int Properties::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = PropertiesLayout::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 1)
