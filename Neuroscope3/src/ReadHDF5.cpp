...
//    long lLengthST;
//    Read1DArray(&spikeTimes, lLengthST, hsFileName, nwb_spike_times);

//    int *spikeIndices = NULL;
//    long lLengthSI;
//    Read1DArray(&spikeIndices, lLengthSI, hsFileName, nwb_spike_times_index);

//    std::string *spikeNames = NULL;
//    long lLengthSN;
//    Read1DArray(&spikeNames, lLengthSN, hsFileName, nwb_units_electrode_group);
